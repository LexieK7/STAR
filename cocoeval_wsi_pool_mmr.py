...
import pickle
import json
from train_6fea_pool_mmr import ClipCaptionModel 
...
with open('./data/CRC_report/annotations_mmr/TCIH_CRC_TEST_MMR.json', 'r') as f:
    data = json.load(f)
print("%0d captions loaded from json " % len(data))
all_captions = {}
gt_captions = {}

base_path = "PATH TO .PT FILE"
...
for i in tqdm(range(len(data))):
    ...
    with torch.no_grad():
        ...
        prefix_embed = prefix_10x.reshape(1, 6, 768)
